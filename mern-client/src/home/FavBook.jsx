  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
      ...
      <div className='md:w-1/2 space-y-6'>
        ...
        <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur expedita quis asperiores accusantium rem facilis, cumque earum obcaecati vitae accusamus voluptatem placeat ipsa, laudantium soluta atque sit aliquam suscipit assumenda?</p>
        {/* stats div*/}
